...
<g:if test="${	params.controller != null
	...
	<ul id="Menu" class="nav nav-pills margin-top-small">
		...
		<g:if test="${params.controller != 'attendenceRecord'
		...
		<g:if test="${	params.controller != null && params.controller == 'meeting'}">

			<link href="//netdna.bootstrapcdn.com/bootstrap/3.0.0/css/bootstrap.min.css" rel="stylesheet">

			<li class=${ params.action == "scheduledMeetingList" ? 'active' : '' }>
				<g:link action="scheduledMeetingList"><span style="color:#ffb00f"><i class="glyphicon glyphicon-warning-sign"></i></span> Scheduled Meetings</g:link>
			</li>
