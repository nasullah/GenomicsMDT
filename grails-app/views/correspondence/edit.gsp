...
<body>
	...
	<section id="edit-correspondence" class="first">
		...
		<g:form method="post" class="form-horizontal" role="form" >
			<g:hiddenField name="id" value="${correspondenceInstance?.id}" />
			<g:hiddenField name="version" value="${correspondenceInstance?.version}" />
