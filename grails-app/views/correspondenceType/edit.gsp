...
<body>
	...
	<section id="edit-correspondenceType" class="first">
		...
		<g:form method="post" class="form-horizontal" role="form" >
			<g:hiddenField name="id" value="${correspondenceTypeInstance?.id}" />
			<g:hiddenField name="version" value="${correspondenceTypeInstance?.version}" />
