...
<body>
	...
	<section id="edit-membershipStatus" class="first">
		...
		<g:form method="post" class="form-horizontal" role="form" >
			<g:hiddenField name="id" value="${membershipStatusInstance?.id}" />
			<g:hiddenField name="version" value="${membershipStatusInstance?.version}" />
