...
<body>
	...
	<section id="edit-proposedDiagnosis" class="first">
		...
		<g:form method="post" class="form-horizontal" role="form" >
			<g:hiddenField name="id" value="${proposedDiagnosisInstance?.id}" />
			<g:hiddenField name="version" value="${proposedDiagnosisInstance?.version}" />
