...
class gsp_genomicsmdt_OMIM_Termedit_gsp extends GroovyPage {
public String getGroovyPageFileName() { "/WEB-INF/grails-app/views/OMIM_Term/edit.gsp" }
public Object run() {
Writer out = getOut()
...
printHtmlPart(1)
invokeTag('set','g',7,['var':("entityName"),'value':(message(code: 'OMIM_Term.label', default: 'OMIM Term'))],-1)
printHtmlPart(1)
createTagBody(2, {->
createTagBody(3, {->
...
createTagBody(2, {->
printHtmlPart(5)
invokeTag('renderErrors','g',17,['bean':(OMIM_TermInstance),'as':("list")],-1)
printHtmlPart(6)
})
invokeTag('hasErrors','g',19,['bean':(OMIM_TermInstance)],2)
printHtmlPart(7)
createTagBody(2, {->
printHtmlPart(8)
invokeTag('hiddenField','g',22,['name':("id"),'value':(OMIM_TermInstance?.id)],-1)
printHtmlPart(8)
invokeTag('hiddenField','g',23,['name':("version"),'value':(OMIM_TermInstance?.version)],-1)
printHtmlPart(8)
...
public static final long LAST_MODIFIED = 1435917306865L
