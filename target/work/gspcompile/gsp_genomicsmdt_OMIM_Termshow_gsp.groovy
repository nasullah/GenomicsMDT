...
class gsp_genomicsmdt_OMIM_Termshow_gsp extends GroovyPage {
public String getGroovyPageFileName() { "/WEB-INF/grails-app/views/OMIM_Term/show.gsp" }
public Object run() {
Writer out = getOut()
...
createTagBody(1, {->
printHtmlPart(4)
invokeTag('message','g',20,['code':("OMIM_Term.omimTermName.label"),'default':("OMIM Term Name")],-1)
printHtmlPart(5)
...
public static final long LAST_MODIFIED = 1435917307009L
