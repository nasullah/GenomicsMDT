...
class gsp_genomicsmdt__errors_500_gsp extends GroovyPage {
public String getGroovyPageFileName() { "/WEB-INF/grails-app/views/_errors/500.gsp" }
public Object run() {
Writer out = getOut()
...
if(true && (exception)) {
printHtmlPart(23)
for( _it1805962469 in (exception.stackTraceLines) ) {
changeItVariable(_it1805962469)
