...
class gsp_genomicsmdt__errors_503_gsp extends GroovyPage {
public String getGroovyPageFileName() { "/WEB-INF/grails-app/views/_errors/503.gsp" }
public Object run() {
Writer out = getOut()
...
createTagBody(2, {->
createTagBody(3, {->
invokeTag('message','g',3,['code':("error.503.title")],-1)
})
...
printHtmlPart(5)
invokeTag('message','g',18,['code':("error.503.callout")],-1)
printHtmlPart(6)
invokeTag('message','g',21,['code':("error.503.title")],-1)
printHtmlPart(7)
invokeTag('message','g',24,['code':("error.503.message")],-1)
printHtmlPart(8)
...
public static final long LAST_MODIFIED = 1434547123434L
