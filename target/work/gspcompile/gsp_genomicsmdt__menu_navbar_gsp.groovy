...
class gsp_genomicsmdt__menu_navbar_gsp extends GroovyPage {
...
printHtmlPart(1)
expressionOut.print(resource(plugin: 'kickstart', dir:'images', file:'favicon.ico'))
printHtmlPart(2)
...
public static final long LAST_MODIFIED = 1435926029237L
