...
class gsp_genomicsmdt_attendenceStatusshow_gsp extends GroovyPage {
public String getGroovyPageFileName() { "/WEB-INF/grails-app/views/attendenceStatus/show.gsp" }
public Object run() {
Writer out = getOut()
...
createTagBody(1, {->
printHtmlPart(4)
invokeTag('message','g',20,['code':("attendenceStatus.attendenceStatusName.label"),'default':("Attendence Status Name")],-1)
printHtmlPart(5)
...
public static final long LAST_MODIFIED = 1435826851373L
