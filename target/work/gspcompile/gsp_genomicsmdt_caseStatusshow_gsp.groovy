...
class gsp_genomicsmdt_caseStatusshow_gsp extends GroovyPage {
public String getGroovyPageFileName() { "/WEB-INF/grails-app/views/caseStatus/show.gsp" }
public Object run() {
Writer out = getOut()
...
createTagBody(1, {->
printHtmlPart(4)
invokeTag('message','g',20,['code':("caseStatus.caseStatusName.label"),'default':("Case Status Name")],-1)
printHtmlPart(5)
...
public static final long LAST_MODIFIED = 1435831337871L
