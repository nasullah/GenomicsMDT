...
class gsp_genomicsmdt_discussionRecordedit_gsp extends GroovyPage {
public String getGroovyPageFileName() { "/WEB-INF/grails-app/views/discussionRecord/edit.gsp" }
public Object run() {
Writer out = getOut()
...
createTagBody(2, {->
printHtmlPart(5)
invokeTag('renderErrors','g',17,['bean':(discussionRecordInstance),'as':("list")],-1)
printHtmlPart(6)
})
invokeTag('hasErrors','g',19,['bean':(discussionRecordInstance)],2)
printHtmlPart(7)
createTagBody(2, {->
printHtmlPart(8)
invokeTag('hiddenField','g',22,['name':("id"),'value':(discussionRecordInstance?.id)],-1)
printHtmlPart(8)
invokeTag('hiddenField','g',23,['name':("version"),'value':(discussionRecordInstance?.version)],-1)
printHtmlPart(8)
...
public static final long LAST_MODIFIED = 1434713964506L
