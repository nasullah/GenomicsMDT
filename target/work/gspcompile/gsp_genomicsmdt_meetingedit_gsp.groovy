...
class gsp_genomicsmdt_meetingedit_gsp extends GroovyPage {
...
createTagBody(2, {->
printHtmlPart(5)
invokeTag('renderErrors','g',17,['bean':(meetingInstance),'as':("list")],-1)
printHtmlPart(6)
})
invokeTag('hasErrors','g',19,['bean':(meetingInstance)],2)
printHtmlPart(7)
createTagBody(2, {->
printHtmlPart(8)
invokeTag('hiddenField','g',22,['name':("id"),'value':(meetingInstance?.id)],-1)
printHtmlPart(8)
invokeTag('hiddenField','g',23,['name':("version"),'value':(meetingInstance?.version)],-1)
printHtmlPart(8)
...
public static final long LAST_MODIFIED = 1434641071015L
