...
class gsp_genomicsmdt_membershipStatusshow_gsp extends GroovyPage {
public String getGroovyPageFileName() { "/WEB-INF/grails-app/views/membershipStatus/show.gsp" }
public Object run() {
Writer out = getOut()
...
createTagBody(1, {->
printHtmlPart(4)
invokeTag('message','g',20,['code':("membershipStatus.membershipStatusName.label"),'default':("Membership Status Name")],-1)
printHtmlPart(5)
...
public static final long LAST_MODIFIED = 1435830031720L
