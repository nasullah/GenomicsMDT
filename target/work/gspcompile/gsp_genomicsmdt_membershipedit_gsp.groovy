...
class gsp_genomicsmdt_membershipedit_gsp extends GroovyPage {
public String getGroovyPageFileName() { "/WEB-INF/grails-app/views/membership/edit.gsp" }
public Object run() {
Writer out = getOut()
...
createTagBody(2, {->
printHtmlPart(8)
invokeTag('hiddenField','g',22,['name':("id"),'value':(membershipInstance?.id)],-1)
printHtmlPart(8)
invokeTag('hiddenField','g',23,['name':("version"),'value':(membershipInstance?.version)],-1)
printHtmlPart(8)
...
public static final long LAST_MODIFIED = 1434705530082L
