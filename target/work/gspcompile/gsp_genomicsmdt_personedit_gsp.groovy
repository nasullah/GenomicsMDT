...
class gsp_genomicsmdt_personedit_gsp extends GroovyPage {
...
createTagBody(2, {->
printHtmlPart(5)
invokeTag('renderErrors','g',17,['bean':(personInstance),'as':("list")],-1)
printHtmlPart(6)
})
invokeTag('hasErrors','g',19,['bean':(personInstance)],2)
printHtmlPart(7)
createTagBody(2, {->
printHtmlPart(8)
invokeTag('hiddenField','g',22,['name':("id"),'value':(personInstance?.id)],-1)
printHtmlPart(8)
invokeTag('hiddenField','g',23,['name':("version"),'value':(personInstance?.version)],-1)
printHtmlPart(8)
...
public static final long LAST_MODIFIED = 1434628797740L
