...
class gsp_genomicsmdt_roleTypeshow_gsp extends GroovyPage {
public String getGroovyPageFileName() { "/WEB-INF/grails-app/views/roleType/show.gsp" }
public Object run() {
Writer out = getOut()
...
createTagBody(1, {->
printHtmlPart(4)
invokeTag('message','g',20,['code':("roleType.roleTypeName.label"),'default':("Role Type Name")],-1)
printHtmlPart(5)
...
public static final long LAST_MODIFIED = 1435833478632L
