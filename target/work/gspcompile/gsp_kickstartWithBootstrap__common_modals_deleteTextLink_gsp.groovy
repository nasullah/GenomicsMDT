...
class gsp_kickstartWithBootstrap__common_modals_deleteTextLink_gsp extends GroovyPage {
public String getGroovyPageFileName() { "/WEB-INF/plugins/kickstart-with-bootstrap-1.1.0/grails-app/views/_common/modals/_deleteTextLink.gsp" }
public Object run() {
Writer out = getOut()
