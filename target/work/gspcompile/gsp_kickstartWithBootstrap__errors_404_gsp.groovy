...
class gsp_kickstartWithBootstrap__errors_404_gsp extends GroovyPage {
public String getGroovyPageFileName() { "/WEB-INF/plugins/kickstart-with-bootstrap-1.1.0/grails-app/views/_errors/404.gsp" }
public Object run() {
Writer out = getOut()
