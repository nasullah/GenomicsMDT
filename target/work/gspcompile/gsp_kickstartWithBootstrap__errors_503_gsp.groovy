...
class gsp_kickstartWithBootstrap__errors_503_gsp extends GroovyPage {
public String getGroovyPageFileName() { "/WEB-INF/plugins/kickstart-with-bootstrap-1.1.0/grails-app/views/_errors/503.gsp" }
public Object run() {
Writer out = getOut()
