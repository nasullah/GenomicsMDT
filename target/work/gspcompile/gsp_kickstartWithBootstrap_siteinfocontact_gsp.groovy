...
class gsp_kickstartWithBootstrap_siteinfocontact_gsp extends GroovyPage {
public String getGroovyPageFileName() { "/WEB-INF/plugins/kickstart-with-bootstrap-1.1.0/grails-app/views/siteinfo/contact.gsp" }
public Object run() {
Writer out = getOut()
