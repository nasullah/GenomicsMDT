...
public String getGroovyPageFileName() { "/WEB-INF/plugins/spring-security-ui-0.2/grails-app/views/register/forgotPassword.gsp" }
public Object run() {
Writer out = getOut()
...
invokeTag('form','s2ui',39,['width':("350"),'height':("220"),'elementId':("forgotPasswordFormContainer"),'titleCode':("spring.security.ui.forgotPassword.header"),'center':("true")],2)
printHtmlPart(11)
})
