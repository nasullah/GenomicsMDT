...
public String getGroovyPageFileName() { "/WEB-INF/plugins/spring-security-ui-0.2/grails-app/views/securityInfo/currentAuth.gsp" }
public Object run() {
Writer out = getOut()
...
printHtmlPart(6)
expressionOut.print(auth.credentials)
printHtmlPart(7)
