...
public String getGroovyPageFileName() { "/WEB-INF/plugins/spring-security-ui-0.2/grails-app/views/securityInfo/mappings.gsp" }
public Object run() {
Writer out = getOut()
...
printHtmlPart(6)
for( entry in (configAttributeMap) ) {
printHtmlPart(7)
expressionOut.print(entry.key)
printHtmlPart(8)
expressionOut.print(entry.value)
printHtmlPart(9)
}
printHtmlPart(10)
})
