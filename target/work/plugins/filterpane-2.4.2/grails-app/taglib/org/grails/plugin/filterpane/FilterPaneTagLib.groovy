...
class FilterPaneTagLib {
    ...
    def filterPane = { attrs, body ->
        ...
        Class clz = new GrailsClassLoader().loadClass('org.codehaus.groovy.grails.validation.DomainClassPropertyComparator')
        clz = clz ?: new GrailsClassLoader().loadClass('org.codehaus.groovy.grails.scaffolding.DomainClassPropertyComparator')
